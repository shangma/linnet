...
A detailed description of installation and build of linNet and the usage
of linNet are documented in the user guide, please refer to file
doc/userGuide/linNet-userGuide.pdf.

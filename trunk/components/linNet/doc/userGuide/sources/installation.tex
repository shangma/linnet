...
\file{c:\bs{}\-Program\-Files}, which doesn't contain blanks, and setting
the environment variable \code{LINNET\_HOME}; it would be set to
\file{c:\bs{}\-Program\-Files\bs{}\-\linnet{}} if the suggested

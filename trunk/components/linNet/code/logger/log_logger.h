...
/** The the line format dependent length of the header of each line. */
...
/** Close a log file. */
boolean log_close(log_hLogger_t hObj);
...
static inline boolean log_checkLogLevel(log_logger_t * const hObj, log_logLevel_t logLevel)
